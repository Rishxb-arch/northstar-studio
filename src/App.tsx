  ...
  return (
    <div className="app-shell">
      <header className="nav">
        ...
        <a className="nav-cta" href="#workspace">Open creator OS <ArrowUpRight size={15} /></a>
      ...
      <main id="top">
        <section className="hero section-pad">
          ...
          <div className="hero-3d-orb" aria-hidden="true"><span></span><i></i><b></b></div>
          <div className="hero-copy reveal">
            <div className="eyebrow"><span className="pulse"></span> Northstar Studio · AI management for creators</div>
            <h1>Your content.<br /><span>Your empire.</span><br />Agentically managed.</h1>
            <p className="hero-sub">Build a local creator brain, turn it into ten production-ready briefs, and run your week from one focused workspace.</p>
            <div className="hero-actions"><a className="button primary" href="#workspace">Build my creator brain <ArrowUpRight size={18} /></a><a className="button text-button" href="#intelligence"><span className="play">▶</span> View workspace</a></div>
            <div className="social-proof"><div className="avatars"><span>AM</span><span>SK</span><span>JL</span><span>+</span></div><p><strong>Private by design</strong> · saved only in this browser</p></div>
          </div>
          <div className="hero-console reveal delay">
            <div className="console-head"><div><span className="status-dot"></span> CREATOR OS / {workspace ? 'READY' : 'SETUP'}</div><span>LOCAL MVP</span></div>
            ...
            <div className="signal-strip"><Database size={15} /><span>Local state</span> {workspace ? 'Workspace saved automatically.' : 'Nothing leaves your device.'}</div>
          </div>
        </section>

        <section className="scroll-stop section-pad" aria-label="Northstar Studio operating layer">
          <div className="scroll-copy">
            <p className="kicker">BUILT LIKE A MANAGEMENT ROOM</p>
            <h2>Not another dashboard. A 3D operating layer around the creator.</h2>
            <p>Northstar turns raw creator context into the decisions a real manager would push every week: what to film, what to skip, what brands fit, and what signal deserves attention.</p>
          </div>
          <div className="studio-stage" aria-hidden="true">
            <div className="stage-ring ring-one"></div><div className="stage-ring ring-two"></div>
            <div className="glass-phone phone-main"><span>HOOK</span><strong>3 mistakes nobody warns you about</strong><i></i></div>
            <div className="glass-phone phone-back"><span>TREND</span><strong>+218%</strong><i></i></div>
            <div className="floating-tile tile-left"><small>AUDIENCE FIT</small><b>91%</b></div>
            <div className="floating-tile tile-right"><small>DEAL MATCH</small><b>94%</b></div>
          </div>
        </section>

        <section className="onboarding section-pad" id="workspace">
          <div className="workspace-intro"><div><p className="kicker">00 / CREATOR ONBOARDING</p><h2>Give the agents<br />your point of view.</h2></div><div><p>Seven inputs become a usable mock strategy system—no account, API key, or backend required.</p><div className="workspace-actions"><button className="button outline" type="button" onClick={loadSample}><Sparkles size={16} /> Load sample</button><button className="button ghost" type="button" onClick={resetWorkspace}><RotateCcw size={15} /> Reset</button></div></div></div>
          <form className="creator-form" onSubmit={createBrain}>
            ...
            <div className="form-submit span-two"><span><Database size={14} /> Saves to localStorage on this device</span><button className="button primary" type="submit">Generate creator workspace <ArrowUpRight size={18} /></button></div>
          </form>
        </section>

        {!workspace ? <section className="empty-state section-pad"><BrainCircuit /><p className="kicker">WORKSPACE WAITING</p><h2>Your agent outputs will appear here.</h2><p>Complete onboarding or load the sample creator to unlock the dashboard.</p><button className="button primary" onClick={loadSample}>Explore with sample data <ArrowUpRight size={17} /></button></section> : <>
          <section className="intelligence section-pad" id="intelligence">
            <div className="section-heading"><div><p className="kicker">01 / CREATOR PROFILE</p><h2>Your positioning,<br />turned into direction.</h2></div><p>A customer-facing strategy card that shows what Northstar understands about the creator—without exposing raw JSON or internal system data.</p></div>
