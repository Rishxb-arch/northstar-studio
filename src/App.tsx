      ...
      <main id="top">
        ...
        {!workspace ? <section className="empty-state section-pad"><BrainCircuit /><p className="kicker">WORKSPACE WAITING</p><h2>Your agent outputs will appear here.</h2><p>Complete onboarding or load the sample creator to unlock the dashboard.</p><button className="button primary" onClick={loadSample}>Explore with sample data <ArrowUpRight size={17} /></button></section> : <>
          <section className="intelligence section-pad" id="intelligence">
            <div className="section-heading"><div><p className="kicker">01 / CREATOR BRAIN</p><h2>A strategy you can<br />inspect and use.</h2></div><p>Generated from your onboarding inputs and persisted as structured JSON in this browser.</p></div>
            <div className="brain-grid output-brain-grid">
              <article className="panel json-card"><div className="panel-title"><BrainCircuit size={19} /><span>CREATOR_BRAIN.JSON</span><small>SAVED LOCALLY</small></div><pre>{JSON.stringify(workspace.brain, null, 2)}</pre></article>
